...
/* Module Version: 5.7 */
/* /usr/local/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 7 -mdiv 1 -ndiv 15 -trimp 0 -phasep 0 -trimp_r -adiv 6 -trims 0 -phases 0 -trims_r -bdiv 26 -phase_cntl STATIC -fb_mode 1 -fracn 38307  */
/* Sat Jun 18 17:03:05 2016 */
...
module pll (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam PLLInst_0.CLKOS_CPHASE = 25 ;
    ...
    defparam PLLInst_0.FRACN_DIV = 38307 ;
    ...
    defparam PLLInst_0.CLKOS_DIV = 26 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS="25.174991" */
             /* synthesis FREQUENCY_PIN_CLKOP="109.091629" */
             /* synthesis FREQUENCY_PIN_CLKI="7.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 25.174991
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 109.091629
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 7.000000
